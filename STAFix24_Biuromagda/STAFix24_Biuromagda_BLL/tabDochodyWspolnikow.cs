...
namespace BLL
{
    public class tabDochodyWspolnikow
    {
        ...
        public static void Get_PrzychodyWspolnika(SPWeb web, int wspolnikId, int okresId, out double przychod, out string specyfikacja)
        {
            ...
            string TABLE_TEMPLATE = @"<table border=""0"" cellpadding=""0"" cellspacing=""0"" style=""FONT-SIZE: x-small; FONT-FAMILY: Arial, Helvetica, sans-serif; WIDTH: 100%;""><tr><th style=""BACKGROUND-COLOR: #e4e4e4; ""><span style=""font-weight: normal"">Firma</span></th><th style=""BACKGROUND-COLOR: #e4e4e4; ""><span style=""font-weight: normal"">Ocena wyniku</span></th><th style=""BACKGROUND-COLOR: #e4e4e4; ""><span style=""font-weight: normal"">Dochód</span></th><th style=""BACKGROUND-COLOR: #e4e4e4; ""><span style=""font-weight: normal"">Strata</span></th></tr>[[TableRow]] </table>";
            string TABLEROW_TEMPLATE = @"<tr><th style=""FONT-SIZE: x-small;  FONT-FAMILY: Arial, Helvetica, sans-serif; BACKGROUND-COLOR: #e4e4e4"">[[Firma]]</th> <td style=""FONT-SIZE: x-small;  FONT-FAMILY: Arial, Helvetica, sans-serif; WHITE-SPACE: nowrap; TEXT-ALIGN: center"">[[OcenaWyniku]]</td> <td style=""FONT-SIZE: x-small; FONT-FAMILY: Arial, Helvetica, sans-serif; WHITE-SPACE: nowrap; TEXT-ALIGN: center"">[[Dochod]]</td> <td style=""FONT-SIZE: x-small; FONT-FAMILY: Arial, Helvetica, sans-serif; WHITE-SPACE: nowrap; TEXT-ALIGN: center"">[[Strata]]</td> </tr>";
